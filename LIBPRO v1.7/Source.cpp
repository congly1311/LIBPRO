...
int Chucnang(int ndht, boolean admin , NguoiDung ngDung[], int quyen, int &m, Quyen q[], char tdn[], Sach sach[], MuonSach muonsach[]) {

	//#######Quyen 0. Them Nguoi dung#######################################################

	if (quyen == 0) {
		if (ngDung[ndht].chucVu == 1||admin==true) {
			system("cls");
	...
	//#######Quyen 4. Xem kho sach.###########################################################################
		...
		if (ngDung[ndht].chucVu == 2 || ngDung[ndht].chucVu == 3) {
			system("cls");
			char ql;
...
//#########Quyen 10. Doi mat khau ################################################
	...
	//########## quyen 13. Tim kiem tai khoan ###############################################################
		...
		if (ngDung[ndht].chucVu == 1 || ngDung[ndht].chucVu == 2||admin==true) {
			system("cls");
			int op;
			fstream inFile("UserData.DAT", ios::in);
	...
	//##########//Quyen 18. Xem danh sach Nguoi dung.########################################################
		...
		if (ngDung[ndht].chucVu == 2 || ngDung[ndht].chucVu == 1||admin==true) {
			system("cls");
			char ql;
	...
	//###########//Quyen 19. Sua thong tin tai khoan.##################################################
		...
		if (ngDung[ndht].chucVu == 1 || ngDung[ndht].chucVu == 2 || ngDung[ndht].chucVu == 3||admin==true) {
			...
			{
			case 1: {
				cout << "So CMND cu: " << ngDung[ndht].sCMND << endl;
				cout << "Nhap so CMND moi: ";
				cin >> ngDung[ndht].sCMND; cin.ignore();
				cout << "Da thay doi so CMND";
				break;
			}
			case 2: {
				cout << "Ten nguoi dung cu: " << ngDung[ndht].tenNguoiDung << endl;
				cout << "Nhap ten nguoi dung moi: ";
				cin.getline(ngDung[ndht].tenNguoiDung, 30);
				cout << "Da thay doi ten nguoi dung";
				break;
			}
			case 3: {
				cout << "Ngay sinh cu: " << ngDung[ndht].ngaySinh << endl;
				cout << "Nhap ngay sinh moi: ";
				cin.getline(ngDung[ndht].ngaySinh, 15);
				cout << "Da thay doi ngay sinh";
				break;
			}
			case 4: {
				cout << "Ten dia chi cu: " << ngDung[ndht].diaChi << endl;
				cout << "Nhap dia chi moi: ";
				cin.getline(ngDung[ndht].diaChi, 50);
				cout << "Da thay doi dia chi";
				break;
			}
			case 5: {
				cout << "Ten tai khoan cu: " << ngDung[ndht].tenDangNhap << endl;
				cout << "Nhap ten tai khoan moi: ";
				cin.getline(ngDung[ndht].tenDangNhap, 30);
...
int main() {
	...
	quyen[19].stt = 19; quyen[19].Admin = quyen[19].ThuThu = quyen[19].DocGia = 1; strcpy(quyen[19].tenQuyen, "Sua tai khoan.");
	...
	*/
	...
	//CapNhatNgDung(ngDung);
	fstream outFile("Sach.DAT", ios::app);
	fstream outFile1("UserData.DAT", ios::app);
	fstream outFile2("MuonSach.DAT", ios::app);
	...
	while (true) {
		...
		do {
			...
			case 1: {
						...
						cout << "|________________________________________________________________|" << endl;
						cout << "Nhap Lua chon: "; cin >> op;
						kt = Chucnang(tkht,admin,ngDung, op, m, quyen, tdn, sach, muonsach);
						break;
			}
			case 2: {
						cout << "__________________________________________________________________" << endl;
