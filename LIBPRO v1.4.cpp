...
int Chucnang(NguoiDung ngDung[], int quyen, int &m, Quyen q[], char tdn[], Sach sach[]) {
	...
	//#######Quyen 4. Xem kho sach.###########################################################################
		...
		cout << "An nut bat ky sau do an enter de quay lai. "; cin >> ql;
		if (ql != 1) {};
	}
	...
	//##########//Quyen 15. Sua thong tin sach ##########################################
		...
		for (int i = 0; i < sl; i++) {
			if (idsach == sach[i].ID) {
				...
				cout << "5. Trang thai" << endl;
				cout << "6. Danh gia" << endl;
				cin >> luachon;
				switch (luachon)
				{
				case 1: {
					cout << "Nhap ten sach moi: " << endl;
				...
				case 5: {
					cout << "Nhap trang thai (1 chua muon, 0 da muon) ";
					cin >> sach[i].trangthai;
					break;
				}
				case 6: {
					cout << "Nhap danh gia: ";
